          ...
          <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
            ...
            <ul className="nav navbar-nav nav-flex-icons ml-auto">
              <li className="nav-item dropdown">
                <button className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true"
                  aria-expanded="false">
                  <i className="fa fa-user"></i> Tài Khoản</button>
                <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                  <button className="dropdown-item waves-effect waves-light">Đăng Ký</button>
                  <button className="dropdown-item waves-effect waves-light">Đăng Nhập</button>
                  <button className="dropdown-item waves-effect waves-light">Đăng Xuất</button>
                </div>
              </li>
            </ul>
          </nav>
